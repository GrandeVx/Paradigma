...
interface CategoryTransactionsViewProps {
  categoryId: string;
  context?: 'home' | 'budgets';
}

export default function CategoryTransactionsView({ categoryId, context = 'home' }: CategoryTransactionsViewProps) {
  ...
  const handleTransactionPress = (transactionId: string) => {
    const basePath = context === 'budgets' ? '/(protected)/(budgets)' : '/(protected)/(home)';
    router.push(`${basePath}/transaction-edit/${transactionId}`);
  };

  ...
  return (
    ...
    >
      <form
        ...
        data-oid="wn:cv7g"
      >
        <div className="flex justify-center" data-oid="77i_9l_">
          <Image
        ...
        <div className="space-y-4" data-oid="cf3_un-">
          {accessToken && refreshToken ? (
            <>
              <div data-oid="uo4:4cn">
                <Label htmlFor="email" data-oid="wz1g_bu">
                  Nuova Password
                </Label>
                <Input
                  id="password"
            ...
            <div
              ...
              data-oid="ebcsacf"
            >
              <p data-oid=":m9s4xx">Access token e refresh token non Validi</p>
            </div>
          )}
        </div>
      </form>
